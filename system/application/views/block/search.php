...
<div class="filter">
<form method="POST">
<table><tr><td>Поиск:</td><td colspan="2" align="left"><input name="searchq" value="<?=@$search?>" style="width:350px"></td>
<td colspan="2" align="left">
<?
$predl=$spros= "";
if(!empty($Type)){
	if($Type=='predl') $predl=" checked=\"checked\"";
	elseif($Type=='spros') $spros=" checked=\"checked\"";
}//else {$Type = 'predl';$predl=" checked";}
?>
<span class="art">
&nbsp;&nbsp;&nbsp;<input type="checkbox" name="predl" <?=$predl?>>Предложение 
&nbsp;&nbsp;&nbsp;<input type="checkbox" name="spros" <?=$spros?>>Спрос
</span>
</td></tr>
<tr><td style="padding:5px 0 0 8px;">
