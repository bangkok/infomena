...
<tr>
	<td colspan="3" class="pereg_horiz" height="10"></td>
</tr>
<tr>
	<td  colspan="3">
<?=$user->detailed_info?>
...
<div class="spros">
			...
			<td width="220">
				...
				<tr><td colspan="2"><div class="image"><?if(!empty($c->prevue)){?><img class="image" src="/image/<?=$c->prevue?>.jpg"><?}?></div></div></td></tr>
...
<input type="hidden" value="<?=$c->id?>" name="pos">
</form></div></td></tr>
