			...
			<td valign="top">
				...
				<tr><td>
					<table cellspacing="0" cellpadding="0" width="100%"><tr>
						...
						<td nowrap align="right" valign="bottom"><a href="/ppage/my_bussines/one_predl/<?=$c->id?>">Подробнее</a></td>
					</tr></table>					
				</td></tr>
				</table>			
			</td>
...
<?}else{?>
Сегодня нет новых предложений, Вы можете <a href="/ppage/my_bussines/add">добавить свои</a>
<?}?>