...
class CI_Validation {
	...
	{ 
	  ...
	  //print"<br> ----- ".preg_match("/^[a-zа-я]+$/i", "привет");
	  //setlocale(LC_CTYPE, 'ru_RU');
	  //print preg_quote($str);
	  //if(preg_match('/^[A-Za-zА-Яа-я]+$/i',$str)) print"<br> ---------- ";
	  return (!preg_match('/^[A-Za-zA-��-� ]+$/i',$str)) ? FALSE : TRUE;
	  //return (!preg_match('/[^\w+$]/i',$str)) ? FALSE : TRUE;
