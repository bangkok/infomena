    ...
    var swfu = new SWFUpload(
        {
            ...
            file_upload_limit : "0",
            debug: false,
            post_params: {'pos':pos, 'type':'bussines'},
            ...
            button_text_style : ".uploadBtn { font-size: 14px; font-family: Verdana; background-color: #FFFFFF; color:#EEEEEE;}",
